...
/** getChart POST /api/chart/getChart */
export async function getChartUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/getChart', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** getChartByThread POST /api/chart/getChart/async */
export async function getChartByThreadUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartByThreadUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/getChart/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** getChartByMQ POST /api/chart/getChart/mq */
export async function getChartByMqUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartByMQUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/getChart/mq', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** reloadChart GET /api/chart/reload */
export async function reloadChartUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.reloadChartUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/chart/reload', {
    method: 'GET',
    params: {
      ...params,
    },
